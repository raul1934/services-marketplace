...
| 23 | **`accessibilityRole="button"` nos textos-como-botão** | "Aprovar"/"Recusar"/"Cancelar" sem role/target (`ProposalsList.tsx:387`) | **P** | **Médio** | Trocar `<Text onPress>` por `Pressable role=button` + `hitSlop` | A11Y-04 | ◐ `41ade70`, `36b817e` |
