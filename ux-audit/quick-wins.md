...
| 16 | **Rótulos de campo persistentes** | Placeholder-como-label some ao digitar (`AuthField.tsx:35`) | **M** | **Alto** | Label acima do input no `AuthField`/`Field` (conserta login+register) | AUTH-04 | ◐ `2fdf10b` |
