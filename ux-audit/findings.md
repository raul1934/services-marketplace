...
| CONS-03 | CONS | Médio | ETA inconsistente entre superfícies | Card mostra `1h4` (truncado), notificações `64 min`, rastreio `~16 min`. | walkthrough #3 `16,23,17` | Formatter único de ETA. | P | Médio | ◐ parcial — etaLabel com zero-pad ("1h04"); as superficies ainda formatam diferente |
