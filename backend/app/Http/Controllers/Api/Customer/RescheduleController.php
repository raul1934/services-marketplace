...
/** Client requests a reschedule, or responds to the provider's request. */
class RescheduleController extends Controller
{
    ...
    public function store(Request $request, ServiceRequest $serviceRequest): JsonResponse
    {
        ...
        $reschedule = $this->service->request($serviceRequest, $request->user(), 'client', $data);
    ...
    {
        abort_unless($rescheduleRequest->request->client_id === $request->user()->id, 403);
