...
Route::prefix('provider/v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'abilities:provider'])->group(function () {
        ...
        Route::prefix('provider/field')->group(function () {
            ...
            Route::post('os/{site}/services', [FieldOsController::class, 'addService']);
            Route::delete('os/{site}/performances/{performance}', [FieldOsController::class, 'removeService']);
            Route::post('os/{site}/performances/{performance}/resources/{resource}', [FieldOsController::class, 'addResource']);
            Route::delete('os/{site}/performances/{performance}/resources/{resource}', [FieldOsController::class, 'removeResource']);
